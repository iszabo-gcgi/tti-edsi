 ...
 * @package      iszabo-gcgi
 * @author       TTI Group
 * @copyright    2022 https://groups.tti.tamu.edu/cts2
 * @license      GPL-2.0+
 *
 * @wordpress-plugin
 * Plugin Name:  CTS - EDSI
 * Plugin URI:   https://github.com/iszabo-gcgi/tti-edsi
 * Description:  Core functionality for CTS on TTIBase (EDSI).
 * Version:      1.0.0
 * Author:       TTI Group
 * Author URI:   https://github.com/iszabo-gcgi
 * Author Email: malba@gcgiglobal.com
